...
import {getContent} from '../../utils/notiondb'
const axios = require('axios');


  
const FeaturedJobs = ({content}) => {
  ...
  // useEffect(() => {
  //   const url = `https://api.notion.com/v1/databases/${NOTION_DATABASE}`
  //   axios.get(url, {
  //       headers: {
          ...
          <div className="row align-items-center pb-14">
            ...
            <div className="col-12 col-xl-6 col-lg-6">
              <div className="text-center text-lg-left mb-13 mb-lg-0">
                <h2 className="font-size-9 font-weight-bold">Hello!</h2>
              </div>
            </div>
            {/* <!-- Section Button --> */}
            <div className="col-12 col-xl-6 col-lg-6">
