          ...
          <div className="row">
            <div className="col-lg-4 col-sm-6 mb-lg-0 mb-9">
              ...
              <div className="media mb-11">
                ...
                <div className="media-body pl-5">
                  <p className="mb-0 font-size-4 text-white">Пиши нам по почте:</p>
                  <Link href="/#">
                    <a className="mb-0 font-size-4 font-weight-bold text-secondary">
                      info@edukation.pro
                    </a>
                  </Link>
                </div>
            ...
            <div
              ...
              >
                ...
                <div className="pb-xl-0 pb-9 text-xl-left text-center">
                  <h2 className="text-white font-size-8 mb-4">
                    Бесплатные консультации по обучению в Корее
                  </h2>
                  <p className="text-hit-gray font-size-5 mb-0">
                  Мы - стартап в сфере образования, с офисом в Южной Корее, 
                  который основан командой с дальновидными взглядами с миссией помочь 
                  русскоязычным студентам в получении образования за границей и 
